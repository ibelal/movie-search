    ...
    <div className="card-poster pb-4">
      <div className="row px-0 mx-0">
        {personDetails.profile_path ? (
          <>
            <img
              className="img-fluid rounded-3 d-none d-md-block d-lg-block px-0"
              src={`${img_path}${personDetails.profile_path}`}
              alt={personDetails.name}
            />
            <img
              className="img-fluid mx-auto rounded-3 d-sm-block d-md-none d-lg-none px-0"
          ...
          <img
            className="no-image-person img-fluid rounded-3"
            src={noimage}
            alt={personDetails.name}
          />
        )}
